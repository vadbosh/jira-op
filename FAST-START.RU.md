...
Спросят ровно три вещи: **story points**, **какой спринт** и **End Date**
(«не надо» — нормальный ответ). Остальное берётся из проекта или пишется в
черновик. Эпик не проставляется никогда — привяжете руками, если он нужен.

Дальше черновик печатается целиком — описание, риски, критерии приёмки — и
ничего не создаётся, пока вы не одобрите.
